...
export function registerExtractTool(server) {
    server.tool("mural_extract_board", "Extract all widgets from a Mural board, grouped by type. Returns the full board spec as JSON.", { url: z.string().describe("Mural board URL or ID") }, async ({ url }) => {
